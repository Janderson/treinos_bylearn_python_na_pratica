def main():
    ...
    # criar string com multiplas linhas = marculina_lyrics (grudado)
    # ==> SEU CÓDIGO AQUI
    ...
    # quebrar marculina_lyrics em palavras (comando: ?)
    # ==> SEU CÓDIGO AQUI
    ...
    # Mostrar palavras depois da limpeza da nova_linha
    # ==> SEU CÓDIGO AQUI
    ...
    # pegar a última frase da música (conceito: indice negativo)
    # ==> SEU CÓDIGO AQUI
    ...
    # pegar duas frases e adicionar (ou imendar) ao marculina_lyrics_frases
    # ==> SEU CÓDIGO AQUI
